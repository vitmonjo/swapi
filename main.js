...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _styles_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./styles.css */ \"./src/styles.css\");\n/* harmony import */ var _modules_dom__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/dom */ \"./src/modules/dom.js\");\n\n\n\n(0,_modules_dom__WEBPACK_IMPORTED_MODULE_1__.setTabs)();\n\n\n\n//# sourceURL=webpack://swapi/./src/index.js?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   checkExistence: () => (/* binding */ checkExistence),\n/* harmony export */   countInstances: () => (/* binding */ countInstances),\n/* harmony export */   getInstances: () => (/* binding */ getInstances),\n/* harmony export */   storeRecords: () => (/* binding */ storeRecords)\n/* harmony export */ });\nfunction countInstances(string) {\n    let counter = 0;\n    for (let i = 0; i < localStorage.length; i++) {\n        const currentStoredItem = localStorage.key(i);\n        if (String(currentStoredItem).includes(string)) counter++;\n    }\n    return counter;\n}\n\nfunction checkExistence(string) {\n    return localStorage.getItem(`${string}-0`);\n}\n\nfunction getInstances(string) {\n    const instances = [];\n    for (let i = 0; i < countInstances(string); i++) {\n        instances.push(localStorage.getItem(`${string}-${i}`));\n    }\n    return instances;\n}\n\nfunction storeRecords(records, caller) {\n    for (let i = 0; i < records.length; i++) {\n        localStorage.setItem(`${caller}-${i}`, `${records[i]}`);\n    }\n}\n\n//# sourceURL=webpack://swapi/./src/modules/localStorage.js?");

/***/ }),

/***/ "./src/fonts/DISTGRG_-webfont.woff":
/*!*****************************************!*\
  !*** ./src/fonts/DISTGRG_-webfont.woff ***!
  \*****************************************/
/***/ ((module, __unused_webpack_exports, __webpack_require__) => {

eval("module.exports = __webpack_require__.p + \"43f614a6a66bd63ddc3c.woff\";\n\n//# sourceURL=webpack://swapi/./src/fonts/DISTGRG_-webfont.woff?");
...
eval("module.exports = __webpack_require__.p + \"c5c739026384efcfb99f.jpg\";\n\n//# sourceURL=webpack://swapi/./src/images/wallpaper.jpg?");
